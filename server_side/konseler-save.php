...
if(1==2){//mysqli_num_rows($cek)>=1){
	...
	$query="insert into konseler (
		...
		values
		(
		'".mysqli_real_escape_string($con,$_POST['frmNamaKonseler'])."',
		'".mysqli_real_escape_string($con,$_POST['frmNoHpKonseler'])."',
		'".mysqli_real_escape_string($con,$_POST['frmAlamatKonseler'])."'
		)
	";
