...
if(1==2){//mysqli_num_rows($cek)>=1){
	...
	$query="insert into walikelas (
		...
		values
		(
		'".mysqli_real_escape_string($con,$_POST['frmNamaWaliKelas'])."',
		'".mysqli_real_escape_string($con,$_POST['frmNoHPWali'])."',
		'".mysqli_real_escape_string($con,$_POST['frmid_kelas'])."'
		)
	";
